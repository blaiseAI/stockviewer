...
templates['stock'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                    <tr>\n                        <td>"
    + alias3(((helper = (helper = lookupProperty(helpers,"x") || (depth0 != null ? lookupProperty(depth0,"x") : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"x","hash":{},"data":data,"loc":{"start":{"line":26,"column":28},"end":{"line":26,"column":33}}}) : helper)))
    + "</td>\n                        <td>"
    + alias3((lookupProperty(helpers,"currency")||(depth0 && lookupProperty(depth0,"currency"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"y") : depth0),{"name":"currency","hash":{},"data":data,"loc":{"start":{"line":27,"column":28},"end":{"line":27,"column":42}}}))
    + "</td>\n                    </tr>\n";
  ...
  return "<section class=\"container-fluid\">\n    <div class=\"row p-3 mt-3\">\n        <div class=\"col-sm-12 col-md-5\">\n            <div class=\"hr\">\n                <h1>"
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"pastDays") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":24,"column":20},"end":{"line":29,"column":29}}})) != null ? stack1 : "")
    + "                </tbody>\n            </table>\n        </div>\n    </div>\n     <div class=\"col-12 col-md-7\" id=\"chart\"></div>\n    </div>\n</div>\n</section>";
},"useData":true});
})();